...
"[project]/src/app/api/applications/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    try {
        ...
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.findUnique({
            where: {
                id
            },
            include: {
...
async function PUT(req, { params }) {
    try {
        ...
        if (!newStatus || !Object.values(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f40$prisma$2f$client$29$__["AppStatus"]).includes(newStatus)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const [updated] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.update({
                where: {
                    id
                },
                data: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].statusHistory.create({
                data: {
                    applicationId: id,
        ...
        if (newStatus === "REJECTED") {
            const candidate = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                where: {
                    id: application.candidateId
                }
            });
            if (candidate) {
                __turbopack_context__.A("[project]/src/lib/email.ts [app-route] (ecmascript, async loader)").then(({ sendRejectionEmail })=>{
                    sendRejectionEmail(candidate.email, candidate.name, application.job.title).catch(console.error);
                });
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c49fa42b._.js.map